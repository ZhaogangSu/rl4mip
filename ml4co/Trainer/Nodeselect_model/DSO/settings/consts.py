...
KHALI_FEATURES = KHALI_FEATURES[:30]
...
SVM_DATA_FOR_DSO = osp.join(WORK_DIR, "../node_selection/data_svm")
BEST_EXPRESSION_FILE_PATH = osp.join(WORK_DIR, "results/best/best_expression.json")
...
# 3000改成10，调试
ITER_DICT = defaultdict(lambda : 10)
# 10000改成10，调试
START_EVAL_ITER_DICT = defaultdict(lambda : 10)
GLOBAL_INFO_DICT = {}
...
COLUMN_FEATURES = set(x.lower() for x in FEATURE_NAMES)
...
# WHERE_PSEUDO_SIMPLE = FEATURE_NAMES_SIMPLE.index("ps_product")         # 修改代码
