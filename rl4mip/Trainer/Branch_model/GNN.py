...
class BipartiteGraphConvolution(torch_geometric.nn.MessagePassing):
    ...
    def message(self, node_features_i, node_features_j, edge_features):
        left_out = self.feature_module_left(node_features_i)
        edge_out = self.feature_module_edge(edge_features)
        right_out = self.feature_module_right(node_features_j)
        output = self.feature_module_final(left_out + edge_out + right_out)
        return output
